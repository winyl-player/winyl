...
class SkinPopupElement
{

public:
	SkinPopupElement();
	virtual ~SkinPopupElement();
	SkinPopupElement(const SkinPopupElement&) = delete;
	SkinPopupElement& operator=(const SkinPopupElement&) = delete;
	...
	void LoadSkin(XmlNode& xmlNode, const std::wstring& path, ZipFile* zipFile);
