...
// SkinTreeBack.cpp : implementation file
//
...
bool SkinTreeBack::LoadSkin(XmlNode& xmlNode, std::wstring& path, ZipFile* zipFile)
{
	// Load type
...
void SkinTreeBack::LoadState(XmlNode& xmlNode, std::wstring& path, ZipFile* zipFile, XmlNode& xmlState)
{
	// Add new state
...
SkinTreeBack::Type SkinTreeBack::GetType(XmlNode& xmlNode)
{
...
bool SkinTreeBack::LoadPosition(XmlNode& xmlNode, structPos& pos, structElm& elm)
{
	// Default
	pos.left   = 0;
	pos.right  = 0;
...
bool SkinTreeBack::LoadImage(XmlNode& xmlNode, std::wstring& path, ZipFile* zipFile, structElm& elm)
{
...
bool SkinTreeBack::LoadLine(XmlNode& xmlNode, structElm& elm)
{
...
bool SkinTreeBack::LoadFill(XmlNode& xmlNode, structElm& elm)
{
...
void SkinTreeBack::Draw(HDC dc, CRect& rc, int stateSelect, int stateLine)
{
	if (type == Type::None)
		return;
