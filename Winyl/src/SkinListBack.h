...
public:
	SkinListBack();
	virtual ~SkinListBack();
	SkinListBack(const SkinListBack&) = delete;
	SkinListBack& operator=(const SkinListBack&) = delete;
	...
	void Draw(HDC dc, CRect& rc, int stateSelect, int statePlay, int stateLine, int stateLibrary);
};
